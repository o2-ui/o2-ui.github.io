...
<SizePropsCompareList icon={'month'} sizes={['1.5rem', 30, '48px', '5rem']} />

```tsx
<CarmoreIcon icon={'month'} ... /> // Uses the default ('1.5rem')
<CarmoreIcon icon={'month'} width={30} height={30} ... />
<CarmoreIcon icon={'month'} width={'48px'} height={'48px'} ... />
<CarmoreIcon icon={'month'} width={'5rem'} height={'5rem'} ... />
```
...
<ColorPropsCompareList icon={'month'} colors={['red', 'orange', 'green', 'blue', 'purple']} />
...
```tsx
<CarmoreIcon icon={'month'} className={'text-red'} ... />
<CarmoreIcon icon={'month'} className={'text-orange'} ... />
<CarmoreIcon icon={'month'} className={'text-green'}  ... />
<CarmoreIcon icon={'month'} className={'text-blue'}  ... />
<CarmoreIcon icon={'month'} className={'text-purple'}  ... />
```
...
- The default `aria-label` is 'Calendar'.
- Accessibility defaults are provided, and you can customize them as needed.
- _(Hover the icon to see the tooltip.)_

<A11yPropsCompareList icon={'month'} ariaLabels={[undefined, 'Schedule', 'Plan']} />

```tsx
<CarmoreIcon icon={'month'} ... /> // Uses the default ('Calendar')
<CarmoreIcon icon={'month'} aria-label={'Schedule'} ... />
<CarmoreIcon icon={'month'} aria-label={'Plan'} ... />
```

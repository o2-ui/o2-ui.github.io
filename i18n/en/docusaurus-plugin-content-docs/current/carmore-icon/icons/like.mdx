...
```tsx
<CarmoreIcon icon={'like'} ... /> // Uses the default ('fill')
...
```tsx
<CarmoreIcon icon={'like'} ... /> // Uses the default ('1.5rem')
...
- The default `aria-label` is 'Like'.
...
```tsx
<CarmoreIcon icon={'like'} ... /> // Uses the default ('Like')

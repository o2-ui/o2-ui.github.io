...
<SizePropsCompareList icon={'list'} sizes={['1.5rem', 30, '48px', '5rem']} />

```tsx
<CarmoreIcon icon={'list'} ... /> // Uses the default ('1.5rem')
<CarmoreIcon icon={'list'} width={30} height={30} ... />
<CarmoreIcon icon={'list'} width={'48px'} height={'48px'} ... />
<CarmoreIcon icon={'list'} width={'5rem'} height={'5rem'} ... />
```
...
<ColorPropsCompareList icon={'list'} colors={['red', 'orange', 'green', 'blue', 'purple']} />
...
```tsx
<CarmoreIcon icon={'list'} className={'text-red'} ... />
<CarmoreIcon icon={'list'} className={'text-orange'} ... />
<CarmoreIcon icon={'list'} className={'text-green'}  ... />
<CarmoreIcon icon={'list'} className={'text-blue'}  ... />
<CarmoreIcon icon={'list'} className={'text-purple'}  ... />
```
...
<A11yPropsCompareList icon={'list'} ariaLabels={[undefined, 'List', 'Three lines']} />

```tsx
<CarmoreIcon icon={'list'} ... /> // Uses the default ('List')
<CarmoreIcon icon={'list'} aria-label={'List'} ... />
<CarmoreIcon icon={'list'} aria-label={'Three lines'} ... />
```

...
```tsx
<CarmoreIcon icon={'hotel-credit-card'} ... /> // Uses the default ('1.5rem')
...
- The default `aria-label` is 'Credit card'.
...
```tsx
<CarmoreIcon icon={'hotel-credit-card'} ... /> // Uses the default ('Credit card')

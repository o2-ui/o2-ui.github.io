...
<SizePropsCompareList icon={'country-flag-pl'} sizes={['1.5rem', 30, '48px', '5rem']} />

```tsx
<CarmoreIcon icon={'country-flag-pl'} ... /> // Uses the default ('1.5rem')
...
- The default `aria-label` is 'Poland'.
- Base accessibility defaults are provided, and you can override them when needed.
- _(Hover the icon to check the tooltip.)_

<A11yPropsCompareList icon={'country-flag-pl'} ariaLabels={[undefined, 'Flag']} />

```tsx
<CarmoreIcon icon={'country-flag-pl'} ... /> // Uses the default ('Poland')
<CarmoreIcon icon={'country-flag-pl'} aria-label={'Flag'} ... />
```

...
<SizePropsCompareList icon={'call'} sizes={['1.5rem', 30, '48px', '5rem']} />

```tsx
<CarmoreIcon icon={'call'} ... /> // Uses the default ('1.5rem')
<CarmoreIcon icon={'call'} width={30} height={30} ... />
<CarmoreIcon icon={'call'} width={'48px'} height={'48px'} ... />
<CarmoreIcon icon={'call'} width={'5rem'} height={'5rem'} ... />
```
...
<ColorPropsCompareList icon={'call'} colors={['red', 'orange', 'green', 'blue', 'purple']} />
...
```tsx
<CarmoreIcon icon={'call'} className={'text-red'} ... />
<CarmoreIcon icon={'call'} className={'text-orange'} ... />
<CarmoreIcon icon={'call'} className={'text-green'}  ... />
<CarmoreIcon icon={'call'} className={'text-blue'}  ... />
<CarmoreIcon icon={'call'} className={'text-purple'}  ... />
```
...
- The default `aria-label` is 'Call'.
- Accessibility defaults are provided, and you can customize them as needed.
- _(Hover the icon to see the tooltip.)_

<A11yPropsCompareList icon={'call'} ariaLabels={[undefined, 'Phone number', 'Contact support']} />

```tsx
<CarmoreIcon icon={'call'} ... /> // Uses the default ('Call')
<CarmoreIcon icon={'call'} aria-label={'Phone number'} ... />
<CarmoreIcon icon={'call'} aria-label={'Contact support'} ... />
```

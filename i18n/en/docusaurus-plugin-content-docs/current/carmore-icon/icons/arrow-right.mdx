...
<SizePropsCompareList icon={'arrow-right'} sizes={['1.5rem', 30, '48px', '5rem']} />

```tsx
<CarmoreIcon icon={'arrow-right'} ... /> // Uses the default ('1.5rem')
...
<ColorPropsCompareList icon={'arrow-right'} colors={['red', 'orange', 'green', 'blue', 'purple']} />
...
- The default `aria-label` is 'Right'.
- Accessibility defaults are provided, and you can customize them as needed.
- _(Hover the icon to see the tooltip.)_

<A11yPropsCompareList icon={'arrow-right'} ariaLabels={[undefined, 'Arrow', 'Right arrow']} />

```tsx
<CarmoreIcon icon={'arrow-right'} ... /> // Uses the default ('Right')
<CarmoreIcon icon={'arrow-right'} aria-label={'Arrow'} ... />
<CarmoreIcon icon={'arrow-right'} aria-label={'Right arrow'} ... />
```

...
```tsx
<CarmoreIcon icon={'country-flag-ae'} ... /> // Uses the default ('1.5rem')
...
- The default `aria-label` is 'United Arab Emirates'.
...
```tsx
<CarmoreIcon icon={'country-flag-ae'} ... /> // Uses the default ('United Arab Emirates')

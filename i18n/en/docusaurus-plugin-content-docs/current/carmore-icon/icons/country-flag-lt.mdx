...
```tsx
<CarmoreIcon icon={'country-flag-lt'} ... /> // Uses the default ('1.5rem')
...
- The default `aria-label` is 'Lithuania'.
...
```tsx
<CarmoreIcon icon={'country-flag-lt'} ... /> // Uses the default ('Lithuania')

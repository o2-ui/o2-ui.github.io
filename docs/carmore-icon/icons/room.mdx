...
```tsx
<CarmoreIcon icon={'room'} ... /> // 기본값('1.5rem') 적용
...
<A11yPropsCompareList icon={'room'} ariaLabels={[undefined, '침실', '호텔']} />

```tsx
<CarmoreIcon icon={'room'} ... /> // 기본값('숙실') 적용
<CarmoreIcon icon={'room'} aria-label={'침실'} ... />
<CarmoreIcon icon={'room'} aria-label={'호텔'} ... />
```

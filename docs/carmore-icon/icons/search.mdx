...
<SizePropsCompareList icon={'search'} sizes={['1.5rem', 30, '48px', '5rem']} />
...
<ColorPropsCompareList icon={'search'} colors={['red', 'orange', 'green', 'blue', 'purple']} />
...
<A11yPropsCompareList icon={'search'} ariaLabels={[undefined, '찾아보기', '돋보기']} />
